...
// §7.7. Three levels only. "Non-negotiable" gets amber-soft/amber-ink when
// selected — every other level (including this row's own default,
// "medium") gets green-soft/green — because raising the importance to its
// highest level is meant to feel weightier without reading as an error.
