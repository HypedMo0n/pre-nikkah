...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "border-transparent bg-primary text-white shadow-soft hover:bg-primary/95 active:opacity-80",
  secondary:
    "border-border bg-card text-primary hover:border-primary/30 hover:bg-primary-soft",
  ghost:
    "border-transparent bg-transparent text-primary hover:bg-primary-soft",
  danger:
    "border-concern bg-concern text-white hover:bg-concern/95 active:opacity-80",
};
