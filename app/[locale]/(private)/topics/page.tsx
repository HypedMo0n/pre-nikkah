...
import { buildTopicStages, type TopicStageSummary } from "@/features/topics/stages";
...
// `satisfies` keeps this exhaustive: a new stage without a label would
// otherwise render undefined here rather than failing the build.
